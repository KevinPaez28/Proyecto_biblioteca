...
namespace App\Services\state_rooms;

use App\Models\state_rooms\state_rooms;
use Exception;
use Illuminate\Support\Facades\DB;

class state_roomServices
{
      public function getStates()
    {
        $estates = state_rooms::all();
